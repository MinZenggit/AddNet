...
//
// - alpha_1, beta_1: O(1) and POSITIVE
// - alpha_i, beta_j (for i,j > 1): O(1/n) and NEGATIVE
// - lambda_0 (baseline), gamma (covariate): O(1/n)
//
...
const double CALPHA_INTERNAL = 0.1;
const double CBETA_INTERNAL = 0.1;
const double CGAMMA_INTERNAL = 0.1;
...
double fs(double t, int i, int n) {
  ...
  double alpha_1_val = CALPHA_INTERNAL * 1.0 * time_component;
...
double fr(double t, int j, int n) {
  ...
  double beta_1_val = CBETA_INTERNAL * 1.0 * time_component;
...
NumericVector fsI_cpp(NumericVector t, int i, int n) {
  ...
  double alpha_1_scale = CALPHA_INTERNAL * 1.0;
...
NumericVector frI_cpp(NumericVector t, int j, int n) {
  ...
  double beta_1_scale = CBETA_INTERNAL * 1.0;
